...
class DIN(Model):
    def __init__(self,feature_columns,behavior_feature_list,att_hidden_units=(80,40),
                 ffn_hidden_units=(80,40),att_activation='prelu',ffn_activation='prelu',maxlen=40,
        ...
        self.dense_feature_columns,self.sparse_feature_columns=feature_columns# [][sparseFeature('item_id', item_count, embed_dim),]

        # len
        self.other_sparse_len = len(self.sparse_feature_columns) - len(behavior_feature_list)
        self.dense_len = len(self.dense_feature_columns)
        self.behavior_num = len(behavior_feature_list)#behavior_feature_list: ['item_id']
