...
class Model():
    ...
    # 一个用户有多条记录,根据pos_list来决定的
    # i:代表一条样本中的item，
    # y:代表1还是0
    # hist_i:代表该item对应的history，当遍历到pos_list中的第i个位置时，前i-1个元素为history.
    # s1:代表当前batch中history最大的量
    # uij = (u, i, y, hist_i, sl),hist_i:行代表当前batch数据量，列代表没行数据原始的hist
