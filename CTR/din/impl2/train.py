...
'''
A tensorflow implementation of DIN
Guorui Zhou et all.  "Deep Interest Network for Click-Through Rate Prediction,"  In KDD,2018.
@author: Qiao Guan
'''

flags = tf.app.flags
flags.DEFINE_string("model_dir", "./models", "Base directory for the model")
flags.DEFINE_string("train_data_dir", "{20190205,20190206,20190207,20190208,20190209,20190210,20190211}/v1_tfrecord/",
...
def main(unused_argv):
    ...
    run_config = tf.estimator.RunConfig().replace(
        model_dir=FLAGS.model_dir, session_config=session_config, log_step_count_steps=1000, save_summary_steps=20000,
