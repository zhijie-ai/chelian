...
e_model = Model(x_in, x,name='encoder')
plot_model(e_model,to_file='png/encoder.png',show_shapes=True)
...
g_model = Model(z_in, z,name='generator')
plot_model(g_model,to_file='png/generator.png',show_shapes=True)
...
train_model = Model([x_in,z_in],[z_real,z_fake,z_fake_ng],name='combined')
plot_model(train_model,to_file='png/train_model.png',show_shapes=True)
