...
# summary writer
summary_writer = tf.summary.FileWriter('./summaries/celeba_dcgan_no_bn_no_regular', sess.graph)

""" initialization """
ckpt_dir = './checkpoints/celeba_dcgan_no_bn_no_regular'
...
try:
    ...
    for it in range(sess.run(it_cnt), max_it):
        ...
        if (it + 1) % 20 == 0:
            ...
            save_dir = './sample_images_while_training/celeba_dcgan_no_bn_no_regular'
