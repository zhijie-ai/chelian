...
#这是读了《互怼的艺术：从零直达 WGAN-GP》 文章后的代码
# 代码：https://github.com/bojone/gan/
...
# 提示：参考《GAN论文阅读笔记5：从SVM的Margin到GAN》(https://zhuanlan.zhihu.com/p/58814192)，
#   将真实样本映射到大于1的区间，伪造样本映射到小于-1的区间
import numpy as np
import scipy as sp
from scipy import misc
import glob
import PIL.Image as imageio
...
train_model = Model([x_in, z_in],[x_real_score, x_fake_score, x_fake_ng_score])
