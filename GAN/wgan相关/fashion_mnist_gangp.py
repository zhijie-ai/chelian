...
mnist = input_data.read_data_sets('./fashion')
...
eps = tf.random_uniform([batch_size,1],minval=0.,maxval=1.0)
X_inter = eps * real_X+(1.-eps)*random_Y #文章中eps*假样本+(1-eps)*真样本，实际上代码中是正确的。
