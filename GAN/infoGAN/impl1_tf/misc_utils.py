...
def load_image_dataset(path,desired_height=None,
                       desired_width=None,
                       value_range=None,
                       max_images=None,
...
if __name__ == '__main__':
    path = 'I:\\Users\\xiaojie\\Desktop\\资料\\GAN\\generative-adversarial-networks-master'
    f = find_files_with_extension(path,['.py'])
