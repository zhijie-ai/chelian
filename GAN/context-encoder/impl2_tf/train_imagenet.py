...
bn1, bn2, bn3, bn4, bn5, bn6, debn4, debn3, debn2, debn1, \
...
for epoch in range(n_epochs):
    ...
    for start,end in zip(
        ...
        if iters % 10 == 0:
            ...
            print ("Iter:", iters, "Gen Loss:", loss_G_val, "Recon Loss:",
                   loss_recon_val, "Gen ADV Loss:", loss_adv_G_val,  "Dis Loss:",
                   loss_D_val, "||||", adv_pos_val.mean(), adv_neg_val.min(), adv_neg_val.max())
