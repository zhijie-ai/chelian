...
from keras.layers import Input,Dense,Conv2D,Conv2DTranspose,Activation,\
    LeakyReLU,Flatten,Reshape,BatchNormalization
...
d_model = Model(x_in, x,name='qp_d_model_l2_128')
plot_model(d_model,to_file='png/qp_d_model_l2_128.png',show_shapes=True)
...
g_model = Model(z_in, z,name='qp_g_model_l2_128')
plot_model(g_model,to_file='png/qp_g_model_l2_128.png',show_shapes=True)
...
d_train_model = Model([x_in, z_in],
                      [x_real_score, x_fake_score],name='qp_d_train_model_l2_128')
...
g_train_model = Model([x_in, z_in],
                      [x_real_score, x_fake_score],name='qp_g_train_model_l2_128')
...
# 检查模型结构
plot_model(d_train_model,to_file='png/qp_d_train_model_l2_128.png',show_shapes=True)
plot_model(g_train_model,to_file='png/qp_g_train_model_l2_128.png',show_shapes=True)
