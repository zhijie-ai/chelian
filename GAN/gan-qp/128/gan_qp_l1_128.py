...
plot_model(d_model,to_file='png/qp_d_model_l1_128.png',show_shapes=True)
...
plot_model(g_model,to_file='png/qp_g_model_l1_128.png',show_shapes=True)
...
# 检查模型结构
plot_model(d_train_model,to_file='png/qp_d_train_model_l1_128.png',show_shapes=True)
plot_model(g_train_model,to_file='png/qp_g_train_model_l1_128.png',show_shapes=True)
...
if __name__ == '__main__':
    ...
    for i in range(total_iter):
        for j in range(1):
            ...
            print('==========', d_loss, d_train_model.metrics_names)
        for j in range(1):
            x_sample = img_data.next()
            z_sample = np.random.randn(len(x_sample), z_dim)
