...
#               不胜人生一场醉。                 #
#----------------------------------------------
# https://github.com/eriklindernoren/Keras-GAN/blob/master/discogan/discogan.py
...
from DiscoGAN.impl1_keras.data_loader import DataLoader
...
class DiscoGAN():
    ...
    def build_generator(self,name='generator'):
        ...
        model = Model(d0,output_img,name=name)
