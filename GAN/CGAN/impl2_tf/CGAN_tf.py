...
# 本实现参考:https://github.com/Y1ran/GAN-Network-Library-Tensorflow/blob/master/CGAN.py
import time
            ...
            for idx in range(start_batch_id,self.num_batches):
                ...
                if np.mod(counter,300) == 0:
                    ...
                    save_images(samples[:manifold_h*manifold_w,:,:,:],[manifold_h,manifold_w],
                                ...
                                '_epoch%03d'%epoch+'_test_all_classes_style_by')
...
if __name__ == '__main__':
    ...
    info = CGAN(sess, 50, 32, 100, 'mnist', 'checkpoint', 'results', 'logs')
    info.build_model()
    info.train()
    sess.close()