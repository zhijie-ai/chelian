...
#               不胜人生一场醉。                 #
#----------------------------------------------
# https://github.com/wiseodd/generative-models/blob/master/GAN/dual_gan/dualgan_tensorflow.py
...
# 假设X1为素描域，X2为图片域
# D1为图片域判别器，D2为素描域判别器
X1_sample = G2(X2, z)#将2域变成1域
X2_sample = G1(X1, z)# 将素描转为图片

D1_real = D1(X2)#判断图片是否为真
