...
import sys
from GAN.CycleGAN.impl1_keras.data_loader import DataLoader
import numpy as np
import os
...
class CycleGAN():
    def __init__(self):
        ...
        self.g_AB = self.build_generator('A2B')
        self.g_BA = self.build_generator('B2A')
    ...
    def build_generator(self,name='generator'):
        ...
        model = Model(d0,outputs=output_img,name=name)
    ...
    def sample_images(self, epoch, batch_i):
        ...
        gen_imgs = np.clip(gen_imgs,0,1.0)
