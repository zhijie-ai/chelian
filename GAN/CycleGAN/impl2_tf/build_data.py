...
tf.flags.DEFINE_string('X_input_dir', '../impl1_keras/datasets/apple2orange/trainA',
                       'X input directory, default: ../impl1_keras/datasets/apple2orange/trainA')
tf.flags.DEFINE_string('Y_input_dir', '../impl1_keras/datasets/apple2orange/trainB',
                       'Y input directory, default: ../impl1_keras/datasetsdata/apple2orange/trainB')
tf.flags.DEFINE_string('X_output_file', '../impl1_keras/datasets/tfrecords/apple.tfrecords',
                       'X output tfrecords file, default: ../impl1_keras/datasets/tfrecords/apple.tfrecords')
tf.flags.DEFINE_string('Y_output_file', '../impl1_keras/datasets/tfrecords/orange.tfrecords',
                       'Y output tfrecords file, default: ../impl1_keras/datasets/tfrecords/orange.tfrecords')
