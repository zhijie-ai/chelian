...
import GAN.CycleGAN.impl2_tf.utils as utils
...
def test_reader():
  TRAIN_FILE_1 = '../impl1_keras/datasets/tfrecords/apple.tfrecords'
  TRAIN_FILE_2 = '../impl1_keras/datasets/tfrecords/orange.tfrecords'
