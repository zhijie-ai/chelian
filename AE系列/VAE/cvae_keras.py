...
# 建立模型
vae = Model([x, y], [x_decoded_mean, yh],name='cvae')
plot_model(vae,show_shapes=True,to_file='./cvae.png')

# xent_loss是重构loss，kl_loss是KL loss
xent_loss = K.sum(K.binary_crossentropy(x, x_decoded_mean), axis=-1)
print('K.binary_crossentropy(x, x_decoded_mean).shape',K.binary_crossentropy(x, x_decoded_mean).shape)
