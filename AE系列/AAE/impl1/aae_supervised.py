...
if __name__ == '__main__':
    ...
    for epoch in range(epoch_num):
        ...
        for t, batch in enumerate(train_iter):
            ...
            if t % display_step == 0:
                print('\rEpoch %d, iter %d: dec_rmse=%.2f, dis_acc=%.4f, dis_entropy=%.2f, fool_dis_acc=%.4f, fool_dis_entropy=%.4f' %
                      (epoch, t, metric_dec_rmse.get()[1],
                       metric_dis_accuracy.get()[1],
                       metric_dis_entropy.get()[1],
                       metric_fool_dis_accuracy.get()[1],
