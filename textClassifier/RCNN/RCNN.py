...
#               不胜人生一场醉。                 #
#----------------------------------------------
# https://github.com/jiangxinyang227/textClassifier/blob/master/RCNN/RCNN.ipynb
...
class RCNN(object):
    ...
    def __init__(self, config, wordEmbedding):
        ...
        with tf.name_scope("context"):
            shape = [tf.shape(fwOutput)[0], 1, tf.shape(fwOutput)[2]]#[batch,1,128]
            print('AAAAAAA',fwOutput[:, :-1].shape,fwOutput.shape,bwOutput.shape)
        ...
        with tf.name_scope("wordRepresentation"):
            print('contextLeft.shape,contextRight.shape',self.contextLeft.shape,self.contextRight.shape)
            self.wordRepre = tf.concat([self.contextLeft, self.embeddedWords, self.contextRight], axis=2)
            print('self.wordRepre.shape',self.wordRepre.shape)
        ...
        with tf.name_scope("textRepresentation"):
            ...
            print('self.textRepre.shape',self.textRepre.shape)
