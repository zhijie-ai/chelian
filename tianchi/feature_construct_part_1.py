...
df_part_1_i_u_count_in_6 = df_part_1_in_6.\
    drop_duplicates(['item_id'], 'last')[['item_id', 'i_u_count_in_6']]

# i_u_count_in_3
df_part_1_in_3 = df_part_1[df_part_1['time'] >= \
                           np.datetime64('2014-11-25')].drop_duplicates(['item_id', 'user_id'])
df_part_1_in_3['i_u_count_in_3'] = df_part_1_in_3.groupby('item_id').cumcount() + 1
df_part_1_i_u_count_in_3 = df_part_1_in_3.\
    drop_duplicates(['item_id'], 'last')[['item_id', 'i_u_count_in_3']]

# i_u_count_in_1
df_part_1_in_1 = df_part_1[df_part_1['time'] >= \
                           np.datetime64('2014-11-27')].drop_duplicates(['item_id', 'user_id'])
df_part_1_in_1['i_u_count_in_1'] = df_part_1_in_1.groupby('item_id').cumcount() + 1
df_part_1_i_u_count_in_1 = df_part_1_in_1.\
    drop_duplicates(['item_id'], 'last')[['item_id', 'i_u_count_in_1']]
...
try:
    ...
    path_df.close()
df_part_1_ui_b_count = pd.merge(df_part_1_uic, df_part_1_ui_b_count,
                                on=['user_id', 'item_id'], how='left')
df_part_1_ui_b_count['ui_b_count_rank_in_uc'] = df_part_1_ui_b_count.\
