...
user_pay = pd.read_csv('../../example1/data/user_pay.txt',header=None, names = user_cols).sample(10000)
user_view = pd.read_csv('../../example1/data/user_view.txt',header=None,names = user_cols).sample(10000)
...
user_pay_new.to_csv('user_pay_new.csv',index = False)# 有SHOP_ID,DATE,HOUR,Num_raw,Num_post,DofW
del user_pay_new,user_pay
...
#shop_id,date,hour,Num_raw,每个商铺每天每小时的支付人数
